...
contract Ownable {
                                            ...
                                            onlyOwner 
    {
        ...
        require(newOwner != address(0), "newOwner is already the contract owner!");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    {
        require(_paused == false, "Contract is paused currently");
        _;
    }

    modifier paused()
    {
        require(_paused == true, "Contract is not paused currently");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender != tokenIdOwner, "address can't be the owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenIdOwner || isApprovedForAll(tokenIdOwner, msg.sender), "Only approved for owner and operator!");   
        // TODO add 'to' address to token approvals
        _tokenApprovals[tokenId] = to;
        // TODO emit Approval Event
        emit Approval(tokenIdOwner, to, tokenId);
    }
...
contract ERC721Mintable is ERC721Metadata {
                                        ...
                                        returns(bool)
    {
        ...
        // require(tokenURI == super.tokenURI(tokenId), "tokenURI was not set properly!");
        return true;
    }
}